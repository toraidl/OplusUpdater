...
```shell
$ go install github.com/toraidl/OplusUpdater/cmd/updater@latest
```
For android u can use [toraidl/OplusUpdater-android](https://github.com/toraidl/OplusUpdater-android)
